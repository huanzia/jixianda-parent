...
@Api(tags = "C-end address book APIs")
/**
 * 用户端地址
...
public class AddressBookController {
     ...
     */
    @GetMapping("/list")
    @ApiOperation(value = "查询当前登录用户的全部地址", notes = "Token required: authentication")
     ...
     */
    @PostMapping
    @ApiOperation(value = "新增地址簿记录", notes = "Token required: authentication")
     ...
     */
    @GetMapping("/{id}")
    @ApiOperation(value = "根据地址 id 查询单条地址信息", notes = "Token required: authentication")
     ...
     */
    @PutMapping
    @ApiOperation(value = "更新一条已有地址", notes = "Token required: authentication")
     ...
     */
    @PutMapping("/default")
    @ApiOperation(value = "地址设置为默认地址", notes = "Token required: authentication")
     ...
     */
    @DeleteMapping
    @ApiOperation(value = "删除一条地址", notes = "Token required: authentication")
     ...
     */
    @GetMapping("/default")
    @ApiOperation(value = "查询当前用户的默认地址", notes = "Token required: authentication")
