...
public class DevLoginController {
    ...
    @ApiOperation(
            value = "Dev login (dev only)",
            notes = "Dev only. Optional fields: userId, phone. If both empty, pick first user. Put returned token in authentication header."
    )
    /**
     * 开发环境模拟登录。
