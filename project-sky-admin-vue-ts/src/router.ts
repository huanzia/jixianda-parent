  ...
  routes: [
    {
      ...
      meta: { title: "极鲜达 | FreshLink", hidden: true, notNeedAuth: true }
    },
    {
      path: "/404",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "warehouse",
          component: () =>
            import(/* webpackChunkName: "shopTable" */ "@/views/warehouse/index.vue"),
          meta: {
            title: "仓库管理",
            icon: "el-icon-s-home"
          }
        },
        {
          path: "stock",
          component: () =>
            import(/* webpackChunkName: "shopTable" */ "@/views/stock/index.vue"),
          meta: {
            title: "库存管理",
            icon: "el-icon-box"
          }
