...
import { userBaseUrl } from "../../utils/env"
...
export const userLogin = (params) => {
	return request({
		url: `${userBaseUrl}/user/user/devLogin`,
		method: 'POST',
		params
	})
}
...
export const getNearestWarehouse = (params) => {
	return request({
		url: `${userBaseUrl}/user/warehouse/nearest`,
		method: 'GET',
		params
	})
}
...
export const dishListByCategoryId = (params) => {
	const warehouseId = store.state.warehouseId
	return request({
		url: '/user/dish/list',
		method: 'GET',
		params: {
...
export const queryAddressBookList = (params) => {
	return request({
		url: `${userBaseUrl}/user/addressBook/list`,
		method: 'GET',
		params
	})
}
...
export const putAddressBookDefault = (params) => {
	return request({
		url: `${userBaseUrl}/user/addressBook/default`,
		method: 'PUT',
		params
	})
}
...
export const addAddressBook = (params) => {
	return request({
		url: `${userBaseUrl}/user/addressBook`,
		method: 'POST',
		params
	})
}
...
export const delAddressBook = (id) => {
	return request({
		url: `${userBaseUrl}/user/addressBook/?id=${id}`,
		method: 'DELETE',
		params: { id }
	})
}
...
export const queryAddressBookById = (params) => {
	return request({
		url: `${userBaseUrl}/user/addressBook/${params.id}`,
		method: 'GET',
		params
	})
}
