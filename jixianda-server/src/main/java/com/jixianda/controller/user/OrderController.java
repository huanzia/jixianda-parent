...
public class OrderController {
    ...
    @PostMapping("/submit")
    @ApiOperation(value = "普通下单", notes = "需要token(authentication)。warehouseId 必传，且必须与购物车所属仓库一致。")
    ...
    @PostMapping("/seckill")
    @ApiOperation(value = "秒杀下单", notes = "需要token(authentication)。warehouseId、dishId、addressBookId 为必填参数。")
    ...
    @PutMapping("/payment")
    @ApiOperation(value = "订单支付", notes = "需要登录令牌。")
    ...
    @ApiOperation(value = "历史订单查询", notes = "需要登录令牌。")
    ...
    @ApiOperation(value = "订单详情", notes = "需要登录令牌。")
    ...
    @ApiOperation(value = "取消订单", notes = "需要登录令牌。")
    ...
    @ApiOperation(value = "再来一单", notes = "需要登录令牌。")
    ...
    @ApiOperation(value = "催单", notes = "需要登录令牌。")
